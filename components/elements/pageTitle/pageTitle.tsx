...
const navigation = [
    ...
    { id: 7, name: "お問い合わせ完了",subName: 'Complete', href: "/contact/bird" },
    { id: 8, name: "お問い合わせ失敗",subName: 'Failed', href: "/contact/failed" },
    { id: 9, name: "プライバシーポリシー", subName: 'Privacy Policy',  href: "/privacy" },
];
